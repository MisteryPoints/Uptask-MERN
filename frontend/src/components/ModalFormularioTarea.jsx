...
const ModalFormularioTarea = () => {
    ...
    const { modalFormTarea, handleModalTarea, showAlert, alerta, submitTarea } = useProyectos()
                    ...
                    >
                            ...
                            <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                                ...
                                <span className="sr-only">Cerrar</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
                                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" onClick={() => 
                                        setTimeout(() => {
                                            showAlert({})
                                        }, 1000) }/>
                                    </svg>
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                  ...
                                  <Dialog.Title as="h3" className="leading-6 font-bold text-gray-900 text-4xl select-none">
                                      Crear Tarea
                                  </Dialog.Title>
                                  ...
                                  <form action="" className='my-5' onSubmit={handleSubmit}>
                                    ...
                                    <input type="submit" className='bg-sky-600 hover:bg-sky-700 p-3 w-full text-white uppercase font-bold cursor-pointer transition-colors rounded-lg'/>
                                  </form>
                                </div>
                            </div>
                        </div>
