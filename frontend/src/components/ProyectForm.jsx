...
const ProyectForm = () => {
  ...
  return (
    <form className="bg-white py-10 px-5 md:w-1/2 rounded-lg shadow-md">
      ...
      <input type="submit" value='Crear Proyecto' className="bg-sky-600 w-full text-white uppercase text-lg font-bold rounded-lg p-2 hover:bg-sky-700 cursor-pointer"/>
    </form>
  )
}
