...
const NewPassword = () => {
  ...
  return ( 
    <>
      <h1 className="text-sky-600 font-black text-6xl capitalize select-none">Reestablece tu Password y no pierdas acceso a tus <span className="text-slate-700">Proyectos</span></h1>
      { msg && <Alert alert={alerta} />}
      { tokenValido && (
      <form className="my-10 p-10 bg-white shadow rounded-lg" onSubmit={handleSubmit}>
        <div className="my-5 ">
          <label htmlFor="password" className="uppercase text-gray-600 block text-xl font-bold select-none">Nuevo Password</label>
